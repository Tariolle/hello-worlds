...
\begin{frame}{The question we actually asked}
  ...
  \begin{itemize}
    ...
    \item \textbf{What we ship}: a controlled study with an \emph{honest} answer -- a strong frozen probe, a clean negative result with a geometric mechanism, and latent space visualizations.
  \end{itemize}
\end{frame}
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    ...
    \item \textbf{The null is multi-axis}: geometry/PEIRA help neither accuracy, nor calibration, nor robustness (3 seeds).
