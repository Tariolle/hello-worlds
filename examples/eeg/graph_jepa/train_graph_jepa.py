...
Run:
    python -m examples.eeg.graph_jepa.train_graph_jepa \
        --config examples/eeg/cfgs/graph_jepa.yaml \
...
from eb_jepa.graph_jepa.config import apply_overrides, bind, load_yaml
from eb_jepa.graph_jepa.features import fit_feature_stats, FeatureStats
from eb_jepa.graph_jepa.masking import MaskConfig, make_mask
from eb_jepa.graph_jepa.metrics import evaluate, separation
from eb_jepa.graph_jepa.model import ModelConfig, build_model
from eb_jepa.graph_jepa.scoring import ScoringConfig, score_file_loader
from eb_jepa.graph_jepa.windows import (GraphEEGConfig, GraphEEGDataset,
                                        make_graph_loader)
...
def main():
    ...
    ap.add_argument("--config", default="examples/eeg/cfgs/graph_jepa.yaml")
