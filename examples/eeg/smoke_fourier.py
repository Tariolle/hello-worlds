...
Mirrors smoke.py but for FourierEEGEncoder1D: builds the encoder from
cfgs/train_fourier.yaml and runs encoder -> SSL objective -> loss.backward() on a
...
cluster/train_fourier.sbatch's smoke path, or locally on CPU.
"""
import sys
...
cfg = OmegaConf.load("examples/eeg/cfgs/train_fourier.yaml").model
