...
from src.data.eeg_windows import FeatureNormalizer, load_single_input_windows
from src.data.features import PreprocessConfig
from src.eval.anomaly_scoring import aggregate_scores, score_windows
from src.eval.evaluate_graph_jepa import load_checkpoint
from src.graphs.tcp_graph import TCP_CHANNELS
from src.visualization.plot_anomaly_heatmap import (
    plot_heatmap,
    plot_timeline,
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--output_dir", default="results/graph_jepa_viz")
