...
Usage:
  python -m archive.graph_jepa.v1.train --config archive/graph_jepa/v1/config.yaml
"""
...
from archive.graph_jepa.v1.src.eval.anomaly_scoring import aggregate_file_scores, binary_metrics, score_windows
from archive.graph_jepa.v1.src.graphs.tcp_graph import graph_metadata
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--config", default="archive/graph_jepa/v1/config.yaml")
