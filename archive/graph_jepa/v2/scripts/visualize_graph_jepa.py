...
Run:
    python -m archive.graph_jepa.v2.scripts.visualize_graph_jepa \
        ...
        --edf <path.edf> --output-dir ./archive/graph_jepa/v2/results/viz_local
"""
import argparse
import csv
import json
...
from archive.graph_jepa.v2.core.scoring import (score_recording, top_anomalies,
                                        window_error_maps, window_scores_from_heat)
from archive.graph_jepa.v2.core.windows import read_edf_windows
...
def main():
    ...
    if a.edf:
        ...
        from archive.graph_jepa.v2.core.windows import _load_array
