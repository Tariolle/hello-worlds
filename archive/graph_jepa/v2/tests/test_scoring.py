...
from archive.graph_jepa.v2.core.masking import MaskConfig
...
from archive.graph_jepa.v2.core.scoring import (ScoringConfig, score_recording,
...
def test_injected_anomaly_scores_higher():
    ...
    from archive.graph_jepa.v2.scripts.smoke_graph_jepa import run
...
def test_features_nan_inf_robust():
    from archive.graph_jepa.v2.core.features import FeatureConfig, fit_feature_stats, log_bandpower
...
def test_top_anomalies_skips_unavailable():
    ...
    from archive.graph_jepa.v2.core.tcp_graph import TCP_CHANNELS
